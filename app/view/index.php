...
<body id="web-site" class="" onresize="screenSize()" onload="screenSize()">
    ...
    <?php 
        ...
        require_once "../components/v-libras.php";
        
        $db_query_produtos = new Produto();
        $query_produtos = $db_query_produtos->query_listar_todos_produtos_ativos();
    ?>
                            ...
                            <div class='col'>
                                ...
                                <div class='card p-4 w-100 h-100 justify-content-between'>
                                    ...
                                    <div class='informacoes_produto'>
                                        <div class='descricao mb-1'>{$produto->status_produto}</div>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item mx-1">
                        <button class="btn page-link" type="button" onclick="PaginacaoProdutos(this);">Anterior</button>
                    </li>

                    <li class="page-item  mx-1"><button class="btn page-link active" type="button" onclick="PaginacaoProdutos(this);">1</button></li>
                    <li class="page-item  mx-1"><button class="btn page-link" type="button" onclick="PaginacaoProdutos(this);">2</button></li>
                    <li class="page-item  mx-1"><button class="btn page-link" type="button" onclick="PaginacaoProdutos(this);">3</button></li>


                    <li class="page-item  mx-1">
                        <button class="btn page-link" type="button" onclick="PaginacaoProdutos(this);">Próximo</button>
                    </li>
